...
因为ARM平台下NVRAM特殊的工作模式，已保存的配置可能会失效。主要影响的是默认层，有概率在特定情况下会导致键盘不可用，我们还没有搞明白原因。这个问题可以在重置NVRAM后恢复。

[Planck rev6 上重置 NVRAM](https://cdn.discordapp.com/attachments/473506116718952450/539284620861243409/planck_rev6_default.bin) 可以用于强制重置NVRAM。刷入这个文件后，再次刷入正常固件，会将键盘恢复到_正常_工作状态。
[Preonic rev3 上重置 NVRAM](https://cdn.discordapp.com/attachments/473506116718952450/537849497313738762/preonic_rev3_default.bin)
