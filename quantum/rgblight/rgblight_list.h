...
/*   want to use rgblight_mode_no_nvram(x) instead.                   */
#define rgblight_sethsv_no_nvram_white() rgblight_sethsv_no_nvram(HSV_WHITE)
#define rgblight_sethsv_no_nvram_red() rgblight_sethsv_no_nvram(HSV_RED)
#define rgblight_sethsv_no_nvram_coral() rgblight_sethsv_no_nvram(HSV_CORAL)
#define rgblight_sethsv_no_nvram_orange() rgblight_sethsv_no_nvram(HSV_ORANGE)
#define rgblight_sethsv_no_nvram_goldenrod() rgblight_sethsv_no_nvram(HSV_GOLDENROD)
#define rgblight_sethsv_no_nvram_gold() rgblight_sethsv_no_nvram(HSV_GOLD)
#define rgblight_sethsv_no_nvram_yellow() rgblight_sethsv_no_nvram(HSV_YELLOW)
#define rgblight_sethsv_no_nvram_chartreuse() rgblight_sethsv_no_nvram(HSV_CHARTREUSE)
#define rgblight_sethsv_no_nvram_green() rgblight_sethsv_no_nvram(HSV_GREEN)
#define rgblight_sethsv_no_nvram_springgreen() rgblight_sethsv_no_nvram(HSV_SPRINGGREEN)
#define rgblight_sethsv_no_nvram_turquoise() rgblight_sethsv_no_nvram(HSV_TURQUOISE)
#define rgblight_sethsv_no_nvram_teal() rgblight_sethsv_no_nvram(HSV_TEAL)
#define rgblight_sethsv_no_nvram_cyan() rgblight_sethsv_no_nvram(HSV_CYAN)
#define rgblight_sethsv_no_nvram_azure() rgblight_sethsv_no_nvram(HSV_AZURE)
#define rgblight_sethsv_no_nvram_blue() rgblight_sethsv_no_nvram(HSV_BLUE)
#define rgblight_sethsv_no_nvram_purple() rgblight_sethsv_no_nvram(HSV_PURPLE)
#define rgblight_sethsv_no_nvram_magenta() rgblight_sethsv_no_nvram(HSV_MAGENTA)
#define rgblight_sethsv_no_nvram_pink() rgblight_sethsv_no_nvram(HSV_PINK)
